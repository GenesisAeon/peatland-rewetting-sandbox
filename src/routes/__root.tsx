...
const APP_NAME = "Moor-Wiedervernaessung-Sandbox";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Peatland rewetting honesty map (P131): Guenther 2020 fluxes, Moorschutzstrategie DE, Kreyling 2021 biodiversity. No continuous formulas. No UTAC/CREP/AFET bridge.",
      },
